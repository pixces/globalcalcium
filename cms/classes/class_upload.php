...
class upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        if ($this->lang != 'en_GB' && file_exists('file:///D|/Program/xampp/htdocs/upload/lang/class.upload.' . $lang . '.php')) {
            $translation = null;
            include('file:///D|/Program/xampp/htdocs/upload/lang/class.upload.' . $lang . '.php');
